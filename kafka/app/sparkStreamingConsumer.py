...
kafka_topic_name = "FlowerTopic"
kafka_bootstrap_servers = 'winubuntu:9092,namubuntu:9092'
...
flower_df = spark.readStream.format("kafka").option("kafka.bootstrap.servers", kafka_bootstrap_servers).option(
    "subscribe", kafka_topic_name).option("startingOffsets", "earlist").load()
